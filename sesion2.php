...
<html lang="es">
  ...
  <div class="navbar navbar-fixed-top">
    ...
    <?php if($lock == 'open'): ?>
      ...
      <h6>
      <p>Rut:XXXXXXXX-X / Fecha nac.:XX-XX-XXXX
    </h6>
...
function validaRut(rut){
 ...
 <p>
  ...
  <p>
      ...
      <footer>
       <p><center><h5>Si tiene problemas para ingresar por favor envíe un correo a renovaciones@umce.cl, indicando su nombre rut y fecha de nacimiento</h5></center></p>
       <p>&copy; Informática - UMCE 2013</p>
      </footer>
    <?php endif; ?>
    <?php if($lock == 'close'): ?>
      <div class="container" style="text-align:center">
      <h4>El proceso de renovación de beneficios ha finalizado</h6>
      </div>
