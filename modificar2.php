    ...
    <div class="navbar-inner">
      <div class="container">
        ...
        <div class="nav-collapse">
          <ul class="nav">
            <li><a href="print_formalum.php?var7=<?php echo $rut; ?>"><i class="icon-print"></i> Imprimir Formulario</a></li>
            <li class="divider-vertical"></li>
          </ul>
          <ul class="nav pull-right">
            <li><a href="#"><i class="icon-user"></i> usuario: <?php echo $_SESSION["usuarioactual"]; ?></a></li>
            <li class="divider-vertical"></li>
            <li><a href="form3.php?var=<?php echo $rut; ?>"><i class="icon-off"></i> Cerrar</a></li>
          </ul>
          </ul>
        </div><!-- /.nav-collapse -->
      </div>
            ...
            <div id="divdir" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <form name="dir" action="actualizadir2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divcomuna" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="comuna" action="actualizacomuna2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divfono" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="fono" action="actualizafijo2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divcelu" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="celu" action="actualizacel2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divmail" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="mail" action="actualizamail2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divnac" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="nac" action="actualizanac2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divdiscap" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="discap" action="actualizadiscap2.php?var2=<?php echo $rut; ?>" method="post">
...
<div id="divpueblo" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="pueblo" action="actualizapueblo2.php?var2=<?php echo $rut; ?>" method="post">
...
<legend>Beneficios del estudiante</legend>
          ...
          ?>
             ...
             <!-- Modal para actualizar beca de postulacion-->
                  ...
                  <div class="modal-body">
                  <form name="postula" action="actualizapostula2.php?var2=<?php echo $rut; ?>" method="post">
            ...
            <div id="divdirgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="dirgrp" action="actualizadirgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divcomunagrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="comunagrp" action="actualizacomunagrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divciudadgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="ciudadgrp" action="actualizaciudadgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divfonogrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="fonogrp" action="actualizafonogrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divvivgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="vivgrp" action="actualizavivgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
                  <p>Seleccione la beca a la cual quiere postular</p>
            ...
            <div id="divnombreungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="nombreungrp" action="actualizanombreungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divrutungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="rutungrp" action="actualizarutungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
                  <p>Escriba el RUT</p>
            ...
            <div id="divdirungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="dirungrp" action="actualizadirungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divcomunaungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="divcomunaungrp" action="actualizacomunaungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divciudadungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="divciudadungrp" action="actualizaciudadungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divregionungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="regionungrp" action="actualizaregionungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divecivilungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="ecivilungrp" action="actualizaecivilungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divactivungrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="activungrp" action="actualizaactivungrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
...
<tr>
<td>
<i class="icon-upload"></i> <a href="modificar2.php?page=agregar_integrante&rut=<?php echo $rut; ?>&id=<?php echo $id_alum; ?>">Agregar integrante</a>
</td>
</tr>
<tr>
  <td>
            ...
            <div id="divnombregrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="nombregrp" action="actualizanombregrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
                  <legend>Nombre de la persona</legend>
                  <input type="text" id="nombre" name="nombre" class="span3">
                  <legend>Apellido Paterno</legend>
                  <input type="text" id="ap_pat" name="ap_pat" class="span3">
            ...
            <div id="divrutgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="rutgrp" action="actualizarutgrp2.php?var=<?php echo $id_persona; ?>&var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divedadgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="rutgrp" action="actualizaedadgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divecivilgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="ecivilgrp" action="actualizaecivilgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divparentgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="parentgrp" action="actualizaparentgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divprev_socgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="prev_socgrp" action="actualizaprev_socgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divprev_salgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="prev_salgrp" action="actualizaprev_salgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divniv_estgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="niv_estgrp" action="actualizaniv_estgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divactgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="niv_estgrp" action="actualizaactgrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
            ...
            <div id="divingresogrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="ingresogrp" action="actualizaingresogrp2.php?var2=<?php echo $id_alumno; ?>&var3=<?php echo $rut; ?>" method="post">
