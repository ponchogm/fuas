...
$nombres=$_POST['n_alum'];
$ap_pat_alum=$_POST['ap_pat_alum'];
$ap_mat_alum=$_POST['ap_mat_alum'];
...
$sql="INSERT INTO alumnos (nombres_alum, ap_pat_alum, ap_mat_alum, rut_alum, cod_carrera_alum, anio_ingreso_alum, 
	direccion_alum, comuna_alum, telefono_alum, celular_alum, correo_alum, fecha_nac, nac_alum, pueb_orig_alum, discap_alum, postula_beca_alum )
VALUES
('$nombres','$ap_pat_alum','$ap_mat_alum','$rut_alum','$carrera','$anio_ingreso','$dir_alum','$comuna','$telefono_alum','$cel_alum',
	'$correo_alum','$fnac_alum','$nac_alum','$porigin_alum','$discapacidad_alum','$beca_int')";
...
VALUES
('$id_alum','$dir_hogar','$comuna_hogar','$ciudad_hogar','$telefono_hogar','$vivienda_hogar')";
...
VALUES
('$id_alum','$persona_rut1','$persona_ap_pat1','$persona_ap_mat1','$persona_nombres1','$persona_edad1','$persona_ecivil1','$persona_parent1',
  '$persona_prev_soc1','$persona_prev_sal1','$persona_niv_est1','$persona_act1')";
...
if (!empty($persona_rut1)){
$ing1="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut1','$ingreso_sueldos1','$ingreso_hono1','$ingreso_retiro1','$ingreso_pen1','$ingreso_act_in1','$ingreso_otros1','$ingreso_total1')";
	if (!mysqli_query($con,$ing1))
  	{
  	die('Error: ' . mysqli_error($con));
  	}
}
...
$grp2="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut2','$persona_ap_pat2','$persona_ap_mat2','$persona_nombres2','$persona_edad2','$persona_ecivil2','$persona_parent2',
  '$persona_prev_soc2','$persona_prev_sal2','$persona_niv_est2','$persona_act2')";
...
if (!empty($persona_rut2)) {
$ing2="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut2','$ingreso_sueldos2','$ingreso_hono2','$ingreso_retiro2','$ingreso_pen2','$ingreso_act_in2','$ingreso_otros2','$ingreso_total2')";

if (!mysqli_query($con,$ing2))
  	{
  	die('Error: ' . mysqli_error($con));
  	}
  }
...
$grp3="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut3','$persona_ap_pat3','$persona_ap_mat3','$persona_nombres3','$persona_edad3','$persona_ecivil3','$persona_parent3',
  '$persona_prev_soc3','$persona_prev_sal3','$persona_niv_est3','$persona_act3')";
if (!mysqli_query($con,$grp3))
  {
  die('Error: ' . mysqli_error($con));
  }
 }
...
if(!empty($persona_rut3)){
$ing3="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut3','$ingreso_sueldos3','$ingreso_hono3','$ingreso_retiro3','$ingreso_pen3','$ingreso_act_in3','$ingreso_otros3','$ingreso_total3')";
if (!mysqli_query($con,$ing3))
  {
  die('Error: ' . mysqli_error($con));
  }
 }   
...
$grp4="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut4','$persona_ap_pat4','$persona_ap_mat4','$persona_nombres4','$persona_edad4','$persona_ecivil4','$persona_parent4',
  '$persona_prev_soc4','$persona_prev_sal4','$persona_niv_est4','$persona_act4')";
if (!mysqli_query($con,$grp4))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if (!empty($persona_rut4)){
$ing4="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut4','$ingreso_sueldos4','$ingreso_hono4','$ingreso_retiro4','$ingreso_pen4','$ingreso_act_in4','$ingreso_otros4','$ingreso_total4')";
if (!mysqli_query($con,$ing4))
  {
  die('Error: ' . mysqli_error($con));
  } 
 }
...
$grp5="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut5','$persona_ap_pat5','$persona_ap_mat5','$persona_nombres5','$persona_edad5','$persona_ecivil5','$persona_parent5',
  '$persona_prev_soc5','$persona_prev_sal5','$persona_niv_est5','$persona_act5')";
if (!mysqli_query($con,$grp5))
  {
  die('Error: ' . mysqli_error($con));
  }
 }
...
if(!empty($persona_rut5)){
$ing5="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut5','$ingreso_sueldos5','$ingreso_hono5','$ingreso_retiro5','$ingreso_pen5','$ingreso_act_in5','$ingreso_otros5','$ingreso_total5')";
if (!mysqli_query($con,$ing5))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp6="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut6','$persona_ap_pat6','$persona_ap_mat6','$persona_nombres6','$persona_edad6','$persona_ecivil6','$persona_parent6',
  '$persona_prev_soc6','$persona_prev_sal6','$persona_niv_est6','$persona_act6')";
if (!mysqli_query($con,$grp6))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut6)){
$ing6="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut6','$ingreso_sueldos6','$ingreso_hono6','$ingreso_retiro6','$ingreso_pen6','$ingreso_act_in6','$ingreso_otros6','$ingreso_total6')";
if (!mysqli_query($con,$ing6))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp7="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut7','$persona_ap_pat7','$persona_ap_mat7','$persona_nombres7','$persona_edad7','$persona_ecivil7','$persona_parent7',
  '$persona_prev_soc7','$persona_prev_sal7','$persona_niv_est7','$persona_act7')";
if (!mysqli_query($con,$grp7))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut7)){
$ing7="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut7','$ingreso_sueldos7','$ingreso_hono7','$ingreso_retiro7','$ingreso_pen7','$ingreso_act_in7','$ingreso_otros7','$ingreso_total7')";
if (!mysqli_query($con,$ing7))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp8="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut8','$persona_ap_pat8','$persona_ap_mat8','$persona_nombres8','$persona_edad8','$persona_ecivil8','$persona_parent8',
  '$persona_prev_soc8','$persona_prev_sal8','$persona_niv_est8','$persona_act8')";
if (!mysqli_query($con,$grp8))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut8)){
$ing8="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut8','$ingreso_sueldos8','$ingreso_hono8','$ingreso_retiro8','$ingreso_pen8','$ingreso_act_in8','$ingreso_otros8','$ingreso_total8')";
if (!mysqli_query($con,$ing8))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp9="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut9','$persona_ap_pat9','$persona_ap_mat9','$persona_nombres9','$persona_edad9','$persona_ecivil9','$persona_parent9',
  '$persona_prev_soc9','$persona_prev_sal9','$persona_niv_est9','$persona_act9')";
if (!mysqli_query($con,$grp9))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut9)){
$ing9="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut9','$ingreso_sueldos9','$ingreso_hono9','$ingreso_retiro9','$ingreso_pen9','$ingreso_act_in9','$ingreso_otros9','$ingreso_total9')";
if (!mysqli_query($con,$ing9))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp10="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut10','$persona_ap_pat10','$persona_ap_mat10','$persona_nombres10','$persona_edad10','$persona_ecivil10','$persona_parent10',
  '$persona_prev_soc10','$persona_prev_sal10','$persona_niv_est10','$persona_act10')";
if (!mysqli_query($con,$grp10))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut10)){
$ing10="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut10','$ingreso_sueldos10','$ingreso_hono10','$ingreso_retiro10','$ingreso_pen10','$ingreso_act_in10','$ingreso_otros10','$ingreso_total10')";
if (!mysqli_query($con,$ing10))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp11="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut11','$persona_ap_pat11','$persona_ap_mat11','$persona_nombres11','$persona_edad11','$persona_ecivil11','$persona_parent11',
  '$persona_prev_soc11','$persona_prev_sal11','$persona_niv_est11','$persona_act11')";
if (!mysqli_query($con,$grp11))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut11)){
$ing11="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut11','$ingreso_sueldos11','$ingreso_hono11','$ingreso_retiro11','$ingreso_pen11','$ingreso_act_in11','$ingreso_otros11','$ingreso_total11')";
if (!mysqli_query($con,$ing11))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp12="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut12','$persona_ap_pat12','$persona_ap_mat12','$persona_nombres12','$persona_edad12','$persona_ecivil12','$persona_parent12',
  '$persona_prev_soc12','$persona_prev_sal12','$persona_niv_est12','$persona_act12')";
if (!mysqli_query($con,$grp12))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut12)){
$ing12="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut12','$ingreso_sueldos12','$ingreso_hono12','$ingreso_retiro12','$ingreso_pen12','$ingreso_act_in12','$ingreso_otros12','$ingreso_total12')";
if (!mysqli_query($con,$ing12))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp13="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut13','$persona_ap_pat13','$persona_ap_mat13','$persona_nombres13','$persona_edad13','$persona_ecivil13','$persona_parent13',
  '$persona_prev_soc13','$persona_prev_sal13','$persona_niv_est13','$persona_act13')";
if (!mysqli_query($con,$grp13))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut13)){
$ing13="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut13','$ingreso_sueldos13','$ingreso_hono13','$ingreso_retiro13','$ingreso_pen13','$ingreso_act_in13','$ingreso_otros13','$ingreso_total13')";
if (!mysqli_query($con,$ing13))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp14="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut14','$persona_ap_pat14','$persona_ap_mat14','$persona_nombres14','$persona_edad14','$persona_ecivil14','$persona_parent14',
  '$persona_prev_soc14','$persona_prev_sal14','$persona_niv_est14','$persona_act14')";
if (!mysqli_query($con,$grp14))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut14)){
$ing14="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut14','$ingreso_sueldos14','$ingreso_hono14','$ingreso_retiro14','$ingreso_pen14','$ingreso_act_in14','$ingreso_otros14','$ingreso_total14')";
if (!mysqli_query($con,$ing14))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
...
$grp15="INSERT INTO persona_grupo(persona_id_alum, persona_rut, persona_ap_pat, persona_ap_mat, persona_nombres, persona_edad, persona_ecivil,
persona_parent, persona_prev_soc, persona_prev_sal, persona_niv_est, persona_act )
VALUES
('$id_alum','$persona_rut15','$persona_ap_pat15','$persona_ap_mat15','$persona_nombres15','$persona_edad15','$persona_ecivil15','$persona_parent15',
  '$persona_prev_soc15','$persona_prev_sal15','$persona_niv_est15','$persona_act15')";
if (!mysqli_query($con,$grp15))
  {
  die('Error: ' . mysqli_error($con));
  }
}
...
if(!empty($persona_rut15)){
$ing15="INSERT INTO ingresos(ingreso_alumn_id, ingreso_persona_grp_id, ingreso_sueldos, ingreso_honorario, ingreso_retiro, ingreso_pension,
ingreso_activ_indep, ingreso_otros, ingreso_total )
VALUES
('$id_alum','$persona_rut15','$ingreso_sueldos15','$ingreso_hono15','$ingreso_retiro15','$ingreso_pen15','$ingreso_act_in15','$ingreso_otros15','$ingreso_total15')";
if (!mysqli_query($con,$ing15))
  {
  die('Error: ' . mysqli_error($con));
  }  
}
       echo"<script type='text/javascript'>
            alert('Datos insertados con Exito!');window.location.href=\"form.php\</script>";
