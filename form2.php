        ...
        <div class='controls controls-row'>
          ...
          ?>
            <tr>
              ...
              <td><a data-toggle='modal' href='#divcomgrp'><? echo $comunagrupo; ?></a></td>
              <td><a data-toggle='modal' href='#divcitygrp'><? echo $ciudadgrupo; ?></a></td>
              <td><a data-toggle='modal' href='#divfijogrp'><? echo $fonogrupo; ?></a></td>
            </tr>
          </table>
        </div>  
        <div class='controls controls-row'>
            ...
            <div id="divdirgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="dirgrp" action="actualizadirgrp.php?var2=<? echo $rut; ?>" method="post">
                  <p>Escriba su dirección actual.</p>
            ...
            <div id="divcomgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="comgrp" action="actualizadir.php?var2=<? echo $rut; ?>" method="post">
                  <p>Escriba su comuna actual.</p>
            ...
            <div id="divcitygrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="citygrp" action="actualizadir.php?var2=<? echo $rut; ?>" method="post">
            ...
            <div id="divfijogrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="fijogrp" action="actualizadir.php?var2=<? echo $rut; ?>" method="post">
                  <p>Escriba su teléfono fijo actual.</p>
            ...
            <div id="divvivgrp" class="modal hide fade in" style="display: none;">
              <div class="modal-header">
                <a data-dismiss="modal" class="close">×</a>
                  ...
                  <div class="modal-body">
                  <form name="vivgrp" action="actualizadir.php?var2=<? echo $rut; ?>" method="post">
                  <p>Escriba su dirección actual.</p>
